...
<html lang="en">
  ...
  <body data-spy="scroll" data-target="#main-nav">
    ...
    <div id="myCarousel" class="carousel slide header-display">
      <!-- Indicators -->
        ...
        <div class="carousel-inner"> 
          <img class="logo-dude pull-right" src="img/rdwhite.png" alt="">
    ...
    <div class="section-colored text-center">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1 class="company-title">Reliable Delivers</h1>
              <h1 class="company-sub-title">Courier Service</h1>
            <p></p>
            <hr>
          </div>
        </div><!-- /.row -->
...
<div class="buffer" id="services"></div>
...
<div class="services">
 ...
 <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-12" >
          <h1 class="page-header services-header">Services</h1>
        </div>
  ...
  <div class="buffer" id="contact"></div>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <h1 class="page-header">Contact</h1>
           <p>Call us today for your delivery needs or tell us how your reliable delivers experience was. We love to hear ways we can improve our company!</p>
        </div>
...
<nav class="navbar navbar-inverse navbar-fixed" id="main-nav" role="navigation">
      <div class="container header-display">
        <div class="navbar-header">
          ...
          <a class="navbar-brand nav-text" href="#home">Home
            <!-- <img src="img/rdblack1.jpg" alt=""> -->
          </a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav navbar-right">
            <li class="nav-text "><a href="#services">Services</a></li>
    ...
    <div class="container">
      ...
      <footer>
        <div class="row">
          <div class="col-lg-12">
            <p>Copyright &copy; Reliable Delivers 2014</p>
          </div>
        </div>
      </footer>
...
<script>
  ...
  })(window,document,'script','//www.google-analytics.com/analytics.js','ga');  ga('create', 'UA-47062199-1', 'reliabledelivers.com');
  ga('send', 'pageview');
